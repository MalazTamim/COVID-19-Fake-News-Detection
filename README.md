...
-	Data Processing and cleaning: Because I am dealing with messy texts that contain stopwords, blank lines and unnecessary punctuations, I will have to remove them for our model to perform better. I can use ntlk.stem package to clear the data and perform stemming to reduce inflection in words and get their root form. 
